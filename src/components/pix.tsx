    ...
    <>
      <div className="space-y-10 flex flex-col">
        ...
        <div className="flex justify-center flex-col gap-5">
          <div>
            <p>Aponte a camera do celular para o QR code:</p>
            <img
            ...
            <div className="border p-2 rounded flex gap-2 items-center">
              ...
              <div className="flex items-center">
                <p className="max-w-[350px] whitespace-nowrap overflow-hidden text-ellipsis">
                  ...
                  Omnis nemo autem incidunt. Quasi ratione earum, possimus
                  doloremque maiores assumenda cumque. Quos tenetur eveniet in
                  autem iusto nam eum et beatae.
                </p>
